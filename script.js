const brojProfesor = {
  ...
  45: {
    name: "Љубица Смилесвка Мојсосвка",
  ...
  66: { name: "Верица Јосифоска", predmet: "Слободни часови", predmetCeloIme: "Слободни часови" },
  ...
  2645: {
    name: "Тоде Дукоски/Љубица Смилесвка Мојсовска",
...
const raspored = [
  4, 38, 10, 1, 10, 33, 45, 10, 33, 33, 470, 10, 2645, 24, 22, 1, 38, 2645, 18,
...
for (let i = 0; i < raspored.length; i++) {
  tableData[i].textContent = brojProfesor[raspored[i]].predmet;
  tableData[i].setAttribute("data-pred", raspored[i]);
}
